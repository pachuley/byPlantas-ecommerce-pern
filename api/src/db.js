...
Product.belongsToMany(Category, {through: 'CategoriesXProducts'}, foreignKey: 'productId');
Category.belongsToMany(Product, {through: 'CategoriesXProducts'}, foreignKey: 'orderId');
