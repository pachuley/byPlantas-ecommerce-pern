...
Product.belongsToMany(Category, {through: 'CategoriesXProducts', timestamps: false});
Category.belongsToMany(Product, {through: 'CategoriesXProducts', timestamps: false});
